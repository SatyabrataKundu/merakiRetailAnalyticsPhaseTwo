...
let runPy  =
   new Promise(function (fulfill, reject) {
    ...
    var process = spawn('python',[config.get("environment.constants.homeDirectory")+"Weapon_Detection/TensorFlow/models/research/object_detection/Object_detection_image.py", config.get("environment.constants.homeDirectory")+"Middleware/","image-snapshot.jpg"] ); 
